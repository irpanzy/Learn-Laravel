<nav class="bg-blue-200" x-data="{ isOpen: false }">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <x-nav-link href="/" :active="request()->is('/')"
                            class="text-gray-800 hover:bg-blue-800 hover:text-white rounded-md px-3 py-2 text-base">Home</x-nav-link>
                        <x-nav-link href="/blogs" :active="request()->is('blogs')"
                            class="text-gray-800 hover:bg-blue-800 hover:text-white rounded-md px-3 py-2 text-base">Blog</x-nav-link>
                        <x-nav-link href="/about" :active="request()->is('about')"
                            class="text-gray-800 hover:bg-blue-800 hover:text-white rounded-md px-3 py-2 text-base">About</x-nav-link>
                        <x-nav-link href="/contact" :active="request()->is('contact')"
                            class="text-gray-800 hover:bg-blue-800 hover:text-white rounded-md px-3 py-2 text-base">Contact</x-nav-link>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
